...
venue: "NWU"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
...
humandate: "Sep 25-27, 2023"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:00 am - 5:30 pm"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
...
instructor: ["Matthew Bailes", "Tiaan Bezuidenhout", "Ryan Shannon", "Marisa Geyer", "Christo Venter", "Daniel Reardon", "Matt Miles", "Nick Swainston"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: []     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["christo.venter7@gmail.com","mbailes@swin.edu.au", "nswainston@swin.edu.au"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
